...
class GeminiClient:
    ...
    def _safe_parse_json(self, text: str) -> dict:
        ...
        Attempts to parse JSON, with fallback to extract JSON from markdown.
        Returns structured failure if parsing fails.
        
        Args:
            text: Response text from LLM
            
        Returns:
            Parsed JSON dict or structured failure dict
        """
        try:
